...
const AboutPage = () => (
  ...
  <Message
    ...
    <Card.Group centered>
    <Card>
      <Image height='370px' src='http://image.cdnllnwnl.xosnetwork.com/pics24/400/KN/KNUUGURFURIRDPP.20070212204646.jpg' />
      <Card.Content>
    ...
    <Card>
      <Image height='370px' src='https://scontent-iad3-1.xx.fbcdn.net/v/t1.0-9/33493049_10157366811269325_20159270817366016_o.jpg?_nc_cat=111&_nc_ht=scontent-iad3-1.xx&oh=ba225586d37a1eab60ccc352471d83f2&oe=5CAF7EF5' />
      <Card.Content>
    ...
    <Message size='massive' centered> Also a big Thank You to the CS408 Students and Faculty for your support! </Message>
  </div>
)
